...
public class ParquetFileSourceTest extends RecordAPITestBase {
	...
	/**
	 * Returns a Test Schema for Parquet named parquet_test with one text column
	 * (Binary) named text_in_line.
	 */
	private MessageType generateTestGroupSchema() {
		return new MessageType("parquet_test", new PrimitiveType(Type.Repetition.REPEATED, PrimitiveType.PrimitiveTypeName.BINARY,
				"text_in_line"));
	}
